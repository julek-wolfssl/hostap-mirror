...
def run_rsn_override_mld(dev, apdev, mixed):
    with HWSimRadio(use_mlo=True) as (hapd_radio, hapd_iface), \
        ...
        if mixed:
            ...
            params1['rsn_override_key_mgmt'] = 'SAE SAE-EXT-KEY'
            params1['rsn_override_pairwise'] = 'CCMP GCMP-256'
            params1['rsn_override_mfp'] = '2'
        ...
        dev[0].set("disable_rsn_override", "1")
...
def test_rsn_override_drv_only(dev, apdev):
    ...
    wpas.set("disable_rsn_override", "1")
    wpas.connect(ssid, psk="12345678", key_mgmt="WPA-PSK-SHA256",
                 ieee80211w="2", scan_freq="2412")
